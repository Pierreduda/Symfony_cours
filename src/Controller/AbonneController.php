...
/**
 * @Route("/admin/abonne")
 * On ajoute admin devant pour que tout le controller ne soit accessible que par l'admin
 * Dans le security.yaml on autorise tout de meme le ROLE_BIBLIOTHECAIRE à ajouter un abonné
 */
class AbonneController extends AbstractController
{
    ...
    public function new(Request $request, UserPasswordEncoderInterface $encoder): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $pwd = $encoder->encodePassword($abonne, $password);
            $abonne->setPassword($pwd);
    ...
    /**
     * @Route("/edit/{id}", name="abonne_edit", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/delete/{id}", name="abonne_delete", methods={"DELETE"})
     */
